...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Teleorgscrapperrobot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Teleorgscrapperrobot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Teleorgscrapperrobot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/Teleorgscrapperrobot"
    )
    #
